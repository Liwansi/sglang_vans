...
class SchedulerDisaggregationDecodeMixin:
    ...
    def event_loop_overlap_disagg_decode(self: Scheduler):
        ...
        enable_profiling = os.getenv("SGLANG_NPU_PROFILING",
                                     "0") == "1"  # envs.SGLANG_NPU_PROFILING.get()
        prof_bs = int(os.getenv("SGLANG_NPU_PROFILING_BS", 6))  # envs.SGLANG_NPU_PROFILING_BS.get()
        prof_step = int(os.getenv("SGLANG_NPU_PROFILING_STEP", 20))  # envs.SGLANG_NPU_PROFILING_STEP.get()
