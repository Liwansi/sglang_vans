...
class DSANPUIndexerMixin:
    ...
    def forward_npu(
        ...
        if (
            ...
            if use_indexer_tp and is_prefill:
                return self._indexer_attn_tp_prefill(
                    q,
                    k,
                    fm,
                    actual_seq_lengths_q,
            ...
            elif use_indexer_tp and not is_prefill:
                return self._indexer_attn_tp_decode(
                    q,
                    k,
                    fm,
                    actual_seq_lengths_q,
