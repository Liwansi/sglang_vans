...
#export ASCEND_RT_VISIBLE_DEVICE=6,7,14,15
...
python3 -m sglang.launch_server \
        ...
        --disable-radix-cache --base-gpu-id 8 \
        --trust-remote-code \
	--enable-prefill-delayer \
        --prefill-delayer-max-delay-passes 1 \
        --host 127.0.0.1 --max-running-requests 8 --max-mamba-cache-size 10 \
        --mem-fraction-static 0.65 \
        --port 6003 \
        --cuda-graph-bs 2 4 5 6 7 8 \
        --enable-multimodal \
